...
export default function Header() {
    return (
        <div className="flex justify-between p-6 border-b-2 mb-20 bg-secondary">
            ...
            <div className="flex justify-center"><Link href="https://en.wikipedia.org/wiki/Emmanuel_Macron" className="bg-fuchsia-300 p-2 border-2 rounded-2xl font-bold">Link til OnlyFans</Link></div>
